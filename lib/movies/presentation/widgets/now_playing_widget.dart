...
import 'package:movie_rev_clean_arch/movies/presentation/screens/movie_detail_screen.dart';
...
class NowPlayingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<MoviesBloc>()..add(getNowPlayingMoviesEvent()),
                          ...
                          children: [
                            ShaderMask(
                              ...
                              child: CachedNetworkImage(
                                height: 560.0,
                                imageUrl:
                                    ApiConstances.imageUrl(item.backdropPath),
                                fit: BoxFit.cover,
                              ),
                            ),
                            Align(
