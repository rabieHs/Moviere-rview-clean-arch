...
import 'package:movie_rev_clean_arch/core/network/api_constances.dart';
...
import '../../../core/services/dummy.dart';
        ...
        builder: (context, state) {
          return Scaffold(
            body: MovieDetailContent(
              movie: state.movie,
              recommendations: state.recommandedMovies,
            ),
          );
        },
      ),
        ...
        (context, index) {
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: ApiConstances.imageUrl(recommendation.backdropPath!),
